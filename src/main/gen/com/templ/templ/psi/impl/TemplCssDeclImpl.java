...
public class TemplCssDeclImpl extends ASTWrapperPsiElement implements TemplCssDecl {

  public TemplCssDeclImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TemplVisitor visitor) {
    visitor.visitCssDecl(this);
  }
