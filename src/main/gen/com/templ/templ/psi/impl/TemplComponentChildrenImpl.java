...
public class TemplComponentChildrenImpl extends ASTWrapperPsiElement implements TemplComponentChildren {

  public TemplComponentChildrenImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TemplVisitor visitor) {
    visitor.visitComponentChildren(this);
  }
